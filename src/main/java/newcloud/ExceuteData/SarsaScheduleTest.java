...
import static newcloud.policy.VmAllocationAssignerSarsa.QList;
...
public class SarsaScheduleTest {
    ...
    private static VmAllocationAssignerSarsa vmAllocationAssignerSarsa;
    ...
    public List<Double> execute() throws Exception {
        ...
        for (int i = 0; i < Iteration; i++) {
            ...
            vmAllocationAssignerSarsa = new VmAllocationAssignerSarsa(LEARNING_GAMMA, LEARNING_ALPHA, LEARNING_EPSILON, GenExcel.getInstance());
//            CloudSim.initialize();
            ...
            PowerDatacenterSarsa datacenter = createDatacenter(
                    "Datacenter",
                    PowerDatacenterSarsa.class,
                    hostList,
                    vmAllocationPolicy);
...
//        GenExcel.getInstance().genExcel();
        for (int i = 0; i < PowerDatacenterSarsa.allpower.size(); i++) {
            System.out.println(PowerDatacenterSarsa.allpower.get(i));
            if (PowerDatacenterSarsa.allpower.get(i) < smallestdata) {
                smallestdata = PowerDatacenterSarsa.allpower.get(i);
            }
        }
    ...
    public  PowerDatacenterSarsa createDatacenter(
            String name,
        ...
        DatacenterCharacteristics characteristics = new DatacenterCharacteristics(
                ...
                costPerStorage,
                costPerBw);
        PowerDatacenterSarsa datacenter = new PowerDatacenterSarsa("test", characteristics, vmAllocationPolicy, new LinkedList<Storage>(), 300, vmAllocationAssignerSarsa);
        return datacenter;
    }
