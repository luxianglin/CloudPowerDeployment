...
import static newcloud.ExceuteData.LearningAndNoConvergeScheduleTest.brokerId;
 ...
 */
public class PowerDatacenterLearningAndNoConverge extends PowerDatacenter {
    ...
    private VmAllocationAssignerLearningAndNoConverge vmAllocationAssignerLearningAndNoConverge;
    ...
    public PowerDatacenterLearningAndNoConverge(
            ...
            double schedulingInterval, VmAllocationAssignerLearningAndNoConverge vmAllocationAssignerLearningAndNoConverge) throws Exception {
        ...
        setMigrationCount(0);
        this.vmAllocationAssignerLearningAndNoConverge = vmAllocationAssignerLearningAndNoConverge;
        resetEnvironment();
    }
...
//        }
    ...
    public void getReward() {
        ...
        vmAllocationAssignerLearningAndNoConverge.createLastState_idx(historycpu);
        vmAllocationAssignerLearningAndNoConverge.createState_idx(currentcpu);
        vmAllocationAssignerLearningAndNoConverge.updateQList(targetHost.getId(), totalreward, historycpu, currentcpu);
    }
    ...
    public String convertCPUUtilization(List<Double> cpuutils) {
        ...
        for (Double cpuutil : cpuutils) {
            cpuutil = cpuutil * 100;
            convertList +=cpuutil.toString().substring(0,cpuutil.toString().lastIndexOf("."))+",";
        }
        return convertList;
    }
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        int hostid = vmAllocationAssignerLearningAndNoConverge.createAction(currentcpu);
