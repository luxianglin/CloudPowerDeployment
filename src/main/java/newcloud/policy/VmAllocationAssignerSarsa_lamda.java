...
public class VmAllocationAssignerSarsa_lamda { //强化学习分配策略
    ...
    public void updateQList(int action_idx, double reward, String lastcpulist, String cpulist) { //更新Q值表
        ...
        double delta = finalreward + gamma * QList.get(next_state_idx).get(next_action) - QList.get(state_idx).get(action_idx);
