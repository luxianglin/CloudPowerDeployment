...
import static newcloud.ExceuteData.SarsaScheduleTest.brokerId;
 ...
 */
public class PowerDatacenterSarsa extends PowerDatacenter {
    ...
    private VmAllocationAssignerSarsa vmAllocationAssignerSarsa;
    ...
    public PowerDatacenterSarsa(
            ...
            double schedulingInterval, VmAllocationAssignerSarsa vmAllocationAssignerSarsa) throws Exception {
        ...
        setMigrationCount(0);
        this.vmAllocationAssignerSarsa = vmAllocationAssignerSarsa;
        resetEnvironment();
    }
...
//        }
    ...
    public void getReward() {
        ...
        vmAllocationAssignerSarsa.createLastState_idx(historycpu);
        vmAllocationAssignerSarsa.createState_idx(currentcpu);
        vmAllocationAssignerSarsa.updateQList(targetHost.getId(), totalreward, historycpu, currentcpu);
    }
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        int hostid = vmAllocationAssignerSarsa.createAction(currentcpu);
