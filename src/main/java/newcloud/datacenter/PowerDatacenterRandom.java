...
import static newcloud.ExceuteData.RandomScheduleTest.brokerId;
...
public class PowerDatacenterRandom extends PowerDatacenter {
    ...
    private VmAllocationAssignerRandom vmAllocationAssignerRandom;
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        targetHost = vmAllocationAssignerRandom.getVmAllcaotionHost(getHostList(), vm);
