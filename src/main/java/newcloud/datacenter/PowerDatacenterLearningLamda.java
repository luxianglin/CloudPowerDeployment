...
import static newcloud.ExceuteData.LearningLamdaScheduleTest.brokerId;
 ...
 */
public class PowerDatacenterLearningLamda extends PowerDatacenter {
    ...
    private VmAllocationAssignerLearningLamda vmAllocationAssignerLearningLamda;
    ...
    public PowerDatacenterLearningLamda(
            ...
            double schedulingInterval, VmAllocationAssignerLearningLamda vmAllocationAssignerLearningLamda) throws Exception {
        ...
        setMigrationCount(0);
        this.vmAllocationAssignerLearningLamda = vmAllocationAssignerLearningLamda;
        resetEnvironment();
    }
...
//        }
    ...
    public void getReward() {
        ...
        vmAllocationAssignerLearningLamda.createLastState_idx(historycpu);
        vmAllocationAssignerLearningLamda.createState_idx(currentcpu);
        vmAllocationAssignerLearningLamda.updateQList(targetHost.getId(), totalreward, historycpu, currentcpu);
    }
    ...
    protected void processVmCreate(SimEvent ev, boolean ack) {
        Vm vm = (Vm) ev.getData();
        int hostid = vmAllocationAssignerLearningLamda.createAction(currentcpu);
